	...
	<section class="container-fluid">
			...
			<div class="col-md-12 col-lg-6">
				<div class="media">
				  <div class="media-left media-middle">
				    <img src="<?=base_url('assets/images/market2.png')?>" width="80px">
				  </div>
				  <div class="media-body texto-rojo">
				    <div class="media-heading" style="margin-top: 20px; font-family: 'Gotham-Bold'; font-size: 24px;"><?=mostrar_palabra(511, $palabras)?></div>
				  </div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-md-12 col-lg-6" style="font-family:'Gotham-Book'; font-size: 14px; color:#666666;">
				<?=nl2br(mostrar_palabra(513, $palabras))?>
				<br><br><br>
			...
			<div class="col-md-12 col-lg-6 text-center" style="color: #666666; font-family:'Gotham-Book'; font-size: 17px;">
				<img src="<?=base_url('assets/images/ads5.jpg')?>" class="img-responsive" style="margin:auto;">
				<br>
				<?=mostrar_palabra(512, $palabras)?>
			</div>
		</div>
	</section>
	<!-- /Lead -->
...
function contratar()
{
	...
	$.ajax({
		...
		success: function(data) {
			location.href=SITE_URL+"<?=LINK_ADS?>/index.php/publicaciones/index/<?=MARKET_ADS?>";
