	...
	<section class="container-fluid">
			...
			<div class="col-md-12 col-lg-6">
				<div class="media">
				  <div class="media-left media-middle">
				    <img src="<?=base_url('assets/images/premium2.png')?>" width="80px">
				  </div>
				  <div class="media-body texto-rojo">
				    <div class="media-heading" style="margin-top: 20px; font-family: 'Gotham-Bold'; font-size: 24px;"><?=mostrar_palabra(514, $palabras)?></div>
				  </div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-md-12 col-lg-6" style="font-family:'Gotham-Book'; font-size: 14px; color:#666666;">
				<?=nl2br(mostrar_palabra(516, $palabras))?>
				<br><br><br>
			...
			<div class="col-md-12 col-lg-6 text-center" style="color: #666666; font-family:'Gotham-Book'; font-size: 17px;">
				<img src="<?=base_url('assets/images/ads6.jpg')?>" class="img-responsive" style="margin:auto;">
				<br>
				<?=mostrar_palabra(515, $palabras)?>
			</div>
		</div>
	</section>
	<!-- /Lead -->
...
function contratar()
{
	...
	$.ajax({
		...
		success: function(data) {
			location.href=SITE_URL+"<?=LINK_ADS?>/index.php/pagos/checkout_ads/<?=PAGO_DESTINO_PREMIUM_USER?>";
