...
$('.owl-carousel-header').owlCarousel({
    ...
    nav:true,
    dots:false,
    navText : ['<i class="fal fa-angle-left text-white" style="font-size: 3rem;"></i>','<i class="fal fa-angle-right text-white" style="font-size: 3rem;"></i>'],
    navContainerClass: 'navegacion d-md-flex d-none',
    itemClass: 'owl-item',
    navClass: [
			'owl-prev ml-5',
			'owl-next mr-5'
...
$('.owl-carousel-1').owlCarousel({
    ...
    nav:true,
    dots:false,
    navText : ['<i class="fal fa-angle-left" style="font-size: 3rem;"></i>','<i class="fal fa-angle-right" style="font-size: 3rem;"></i>'],
    navContainerClass: 'navegacion d-md-flex d-none',
