		...
		<div class="row">
            ...
            ?>
              ...
              <div class="form-group col-xs-12 col-sm-6">
                <div id="preview">
                <?php
                  echo "<img id='img_user' src='".base_url()."images/usuarios/".$this->session->userdata('usr_imagen')."' class='img-circle img-user img-responsive'>";
                ?>
                </div>
                <input type="file" name="imagen" id="imagen" class="input-class" accept="image/*" style="display:none" capture/>
                <input type="hidden" name="imagen_ant" id="imagen_ant" value="<?=$this->session->userdata('usr_imagen')?>"/>
                ...
                <?php
                  if($this->session->userdata('usr_imagen') != "perfil.jpg")
                  {
...
var options = {
            ...
            // content
            text: "<?=site_url()?>user_free/index/<?=$this->session->userdata('usr_id')?>",
