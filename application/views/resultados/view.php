		...
		<div class="row">
            ...
            <div class="clearfix"></div>
                ...
                echo "<div style='background:#e5e6e6; padding:15px; margin-left:-15px; margin-right:-15px;'>";
                  ...
                  echo '<span style="-moz-user-select: none; -webkit-user-select: none; -ms-user-select:none; user-select:none;-o-user-select:none;" unselectable="on" onselectstart="return false;" onmousedown="return false;">'.strtolower($producto['usr_mail'])."</span><button data-toggle='tooltip' data-placement='top' title='".mostrar_palabra(317, $palabras)."' class='btn btn-link' onclick='post_click_contacto(".$this->session->userdata('usr_id').",".$producto['usr_id'].",\"".$producto['usr_mail']."\",\"mail\")'><i class='fas fa-copy'></i></button><br>";
                  echo "<a class='btn btn-gris btn-sm' href='".site_url()."user/view/".$producto['usr_id']."'>".mostrar_palabra(151, $palabras)."</a><br>";
                  ...
                  {
                    echo '<span  style="-moz-user-select: none; -webkit-user-select: none; -ms-user-select:none; user-select:none;-o-user-select:none;" unselectable="on" onselectstart="return false;" onmousedown="return false;">'.strtolower($mail['mail_direccion'])."</span><button class='btn btn-link' data-toggle='tooltip' data-placement='top' title='".mostrar_palabra(317, $palabras)."' onclick='post_click_contacto(".$this->session->userdata('usr_id').",".$producto['usr_id'].",\"".$mail['mail_direccion']."\",\"mail\")'><i class='fas fa-copy'></i></button><br>";
                  }
