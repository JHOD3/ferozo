	...
	<section class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="panel panel-danger" id="header_resultados" style="display:none;">
        ...
        <div id="results" class="otros" style="display:none;">
        </div>
...
function CopyLink(id) {
  copyTextToClipboard(SITE_URL+"resultados/view_otro/"+id);
}
...
function buscar()
{
  ...
  $('#loading').show();
    ...
    $.ajax({
      url: SITE_URL+'resultados/buscar_ultimos_ajax/'+offset+'/'+limit,
      dataType: 'json',
      timeout: 5000,
              ...
              htmlData += '<div class="panel-body '+color_visto+'">';
                ...
                htmlData += '<div class="menu-tarjeta">';
                  ...
                  htmlData += '<ul class="dropdown-menu dropdown-menu-right pull-right flip">';
                    htmlData += "<li><a href='"+SITE_URL+"resultados/view_otro/"+item.prod_id+"'><?=mostrar_palabra(151, $palabras)?></a></li>";
...
function set_ofertas()
{
  ...
  $('#filtro_ofertas_off').hide();
    ...
    $.ajax({
      url: SITE_URL+'ads/set_ofertas_ajax',
      dataType: 'json',
      success: function(data) {
        offset = 0;
        limit = 10;
