...
class Paises_model extends CI_Model {
    ...
    public function get_item_code2($lang = "en", $id = FALSE)
    {
        ...
        $query = $this->db->query("SELECT C.ctry_code, C.ctry_nombre_".$lang." as ctry_nombre, C.ctry_code3, C.geonameId, C.cur_code
                                    FROM Country AS C
    ...
    public function get_monedas($lang = "en", $id = FALSE)
    {
        if ($id === FALSE)
        {
